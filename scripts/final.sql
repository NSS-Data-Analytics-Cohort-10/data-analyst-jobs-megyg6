...
SELECT company, ROUND(AVG(star_rating),2) AS avg_stars
FROM data_analyst_jobs
...
GROUP BY company
ORDER BY avg_stars DESC; 
--ANSWER General Motors apears first, but they are tied with 5 other companies for the same rating : Unilever, Microsoft, Nike, American Express, and Kaiser Permanente
...
--there are 619 jobs that mention SQL and have been open for more than 3 weeks
